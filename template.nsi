...
# Pages
  ...
  !define MUI_STARTMENUPAGE_REGISTRY_KEY "Software\NameOffApp" 
...
Section "Uninstall"
  ...
  Delete "$SMPROGRAMS\$StartMenuFolder\NameOffApp.lnk"
  Delete "$SMPROGRAMS\$StartMenuFolder\UninstallApp.lnk"
  RMDir "$SMPROGRAMS\$StartMenuFolder"
  
  # Clean the registry by removing all keys under the Software branch
